...
def print_death_age(people_dict):
    ...
    for person_key, people_list in people_dict.items():
...
def count_genders(people_dict):
    ...
    print(f'Males : {number_of_males}')
    print(f'Females: {number_of_women}')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key, marriage_list in marriages_dict.items():
        ...
        husband_birthday = husband_list[BIRTH_YEAR_INDEX]

        husband_age = wedding_year - husband_birthday

        wife_list = people_dict[wife_key]
        wife_name = wife_list[NAME_INDEX]
        wife_birthday = wife_list[BIRTH_YEAR_INDEX]

        wife_age = wedding_year - wife_birthday
