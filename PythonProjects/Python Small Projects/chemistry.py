...
def main ():
    ...
    chemical_sample = float(input("Enter the mass in grams of the sample: "))
    ...
    parse_formula_call = parse_formula(molecule, periodic_table)

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar_mass = compute_molar_mass(parse_formula_call, periodic_table)

    # Compute the number of moles in the sample.

    moles = chemical_sample / molar_mass

    mass_percent = compute_mass_percentage(parse_formula_call, periodic_table)
